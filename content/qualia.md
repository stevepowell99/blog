...
- **The British Academy**, 2026. The participant survey for its International Writing Workshops tracker, asking researchers across the world how their careers had moved on since the workshop.
- **VIB**, the Flemish life sciences research institute. A pilot with PhD researchers, which the team now wants to write up as a paper.
...
- The Garden also has a [wider collection of case studies](https://garden.causalmap.app/case-studies), mostly on the causal mapping side.
